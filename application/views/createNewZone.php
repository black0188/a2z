      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url(); ?>index.php/zoneController/create_zone"><i class="fa fa-circle-o"></i> Create new zone</a></li>
          </ul>
        </li>
        <li>
        ...
        <div class="col-md-6">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Create new zone</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <form name="newZone" method="post" action="<?php echo base_url(); ?>index.php/zoneController/insertZone" role="form" >
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="zoneName" class="form-control" placeholder="Enter new zone name" required>
                </div>
                <div class="form-group">
