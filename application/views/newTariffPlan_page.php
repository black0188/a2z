<?php
    ...
    if($user_id==NULL){        
        $sdata['login_messages'] = "Login Please";
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>index.php/clientController/createNewClient"><i class="fa fa-circle-o"></i> Create new client</a></li>
            <li class="active"><a href="<?php echo base_url(); ?>index.php/tariffPlanController/newTariffPlan"><i class="fa fa-circle-o"></i> Create new tariff plan</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">New tariff plan</li>
      </ol>
    </section>
        ...
        <div class="col-md-6">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Create New tariff plan</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <form name="newTariff" method="post" action="<?php echo base_url(); ?>index.php/tariffPlanController/insertTariffPlan" role="form">
                <div class="form-group">
                    <p id="profile-name" class="profile-name-card">                        
                        <?php 
                          $massages = $this->session->userdata('save_messages'); 
                          $warning_messages = $this->session->userdata('warning_messages');
                          ...
                          } elseif(isset($warning_messages) and $warning_messages!=""){
                            echo '<font color="red">';
                            echo $warning_messages;
                            $this->session->unset_userdata('warning_messages');
                            echo '</font>';
                          }
                        ?>
                    </p>
                ...
                <!-- text input -->
                <div class="form-group">
                  <label>New tariff plan name</label>
                  <input name="planName" type="text" class="form-control" placeholder="Enter tariff plan name" required>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input name="rate" type="text" class="form-control" placeholder="Enter rate" required>
                </div>
                <!-- /.box-body -->
